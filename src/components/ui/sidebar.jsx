...
const SidebarProvider = React.forwardRef(({
  ...
  const setOpen = React.useCallback((value) => {
    ...
    // This is a no-op in a standard web app, but you can save to localStorage if needed
...
const Sidebar = React.forwardRef(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, ...props }, ref) => {
  ...
  if (isMobile) {
    return (
      <div className="fixed inset-0 z-50" data-mobile="true">
        <div
          className={cn(
            "absolute inset-x-0 top-0 z-20 flex h-svh w-full flex-col bg-sidebar p-6 text-sidebar-foreground",
    ...
    >
      ...
      <div
        className={cn(
          ...
          "group-data-[collapsible=icon]:w-[--sidebar-width-icon]",
          "group-data-[side=left][data-state=collapsed]:left-[calc(var(--sidebar-width)*-1)]",
          "group-data-[side=right][data-state=collapsed]:right-[calc(var(--sidebar-width)*-1)]",
          className
        )}
        {...props}
      >
...
const SidebarTrigger = React.forwardRef(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn("inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:bg-accent hover:text-accent-foreground h-7 w-7", className)}
      onClick={(event) => {
        onClick?.(event);
        toggleSidebar();
      }}
...
const SidebarSeparator = React.forwardRef(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn("mx-2 w-auto bg-sidebar-border", "shrink-0 bg-border h-[1px]", className)}
      {...props}
    />
  );
});
